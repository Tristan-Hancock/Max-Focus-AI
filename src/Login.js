...
if(error){
 ...
 <div className="login-container"> 
    ...
    <div className="loggedin">
      <h1> Success login with google </h1>
      <button onClick={()=> signOut()} class="button1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Signout google&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button> 
    </div>
    ...
    <div class="btn">
      ...
      <button onClick={()=> googleSignIn()} class="button1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Login with google&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button> 
